...
and T350_Fact.F350_Consec_Docto between  desde  and  hasta and T350_Fact.F350_Id_Tipo_Docto ='' and T350_Fact.F350_Id_co ='01'
...
inner join t022_mm_consecutivos on f022_id_cia = t350_fact.f350_id_cia  
 ...
 and t350_fact.f350_consec_docto =  numFact and T350_Fact.F350_Id_Tipo_Docto = ''
 
 /***********SUMA CHEQUE***********/
 select ABS(sum(valor)) valor from DETALLE_CHEQUE
 where Afiliado = '' 
 and Tipo=''--P POSTFECHADOS - D DIARIOS
