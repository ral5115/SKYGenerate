...
Namespace wsGenerarPlano
    ...
    Partial Public Class wsGenerarPlano
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.slnMonoProceso.My.MySettings.Default.slnMonoProceso_wsGenerarPlano_wsGenerarPlano
        ...
        Public Function ImportarDatosTablasXML(ByVal idDocumento As Integer, ByVal strNombreDocumento As String, ByVal idCompania As Integer, ByVal strCompania As String, ByVal strUsuario As String, ByVal strClave As String, ByVal strFuenteDatos As String, ByRef Path As String) As String
            Dim results() As Object = Me.Invoke("ImportarDatosTablasXML", New Object() {idDocumento, strNombreDocumento, idCompania, strCompania, strUsuario, strClave, strFuenteDatos, Path})
            Path = CType(results(1),String)
            Return CType(results(0),String)
        End Function
        
        '''<remarks/>
        Public Overloads Sub ImportarDatosTablasXMLAsync(ByVal idDocumento As Integer, ByVal strNombreDocumento As String, ByVal idCompania As Integer, ByVal strCompania As String, ByVal strUsuario As String, ByVal strClave As String, ByVal strFuenteDatos As String, ByVal Path As String)
            Me.ImportarDatosTablasXMLAsync(idDocumento, strNombreDocumento, idCompania, strCompania, strUsuario, strClave, strFuenteDatos, Path, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub ImportarDatosTablasXMLAsync(ByVal idDocumento As Integer, ByVal strNombreDocumento As String, ByVal idCompania As Integer, ByVal strCompania As String, ByVal strUsuario As String, ByVal strClave As String, ByVal strFuenteDatos As String, ByVal Path As String, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("ImportarDatosTablasXML", New Object() {idDocumento, strNombreDocumento, idCompania, strCompania, strUsuario, strClave, strFuenteDatos, Path}, Me.ImportarDatosTablasXMLOperationCompleted, userState)
        End Sub
        ...
        Public Function ImportarDatosTablasDS(ByVal idDocumento As Integer, ByVal strNombreDocumento As String, ByVal idCompania As Integer, ByVal strCompania As String, ByVal strUsuario As String, ByVal strClave As String, ByVal dsFuenteDatos As System.Data.DataSet, ByRef Path As String) As String
            Dim results() As Object = Me.Invoke("ImportarDatosTablasDS", New Object() {idDocumento, strNombreDocumento, idCompania, strCompania, strUsuario, strClave, dsFuenteDatos, Path})
            Path = CType(results(1),String)
            Return CType(results(0),String)
        End Function
        
        '''<remarks/>
        Public Overloads Sub ImportarDatosTablasDSAsync(ByVal idDocumento As Integer, ByVal strNombreDocumento As String, ByVal idCompania As Integer, ByVal strCompania As String, ByVal strUsuario As String, ByVal strClave As String, ByVal dsFuenteDatos As System.Data.DataSet, ByVal Path As String)
            Me.ImportarDatosTablasDSAsync(idDocumento, strNombreDocumento, idCompania, strCompania, strUsuario, strClave, dsFuenteDatos, Path, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub ImportarDatosTablasDSAsync(ByVal idDocumento As Integer, ByVal strNombreDocumento As String, ByVal idCompania As Integer, ByVal strCompania As String, ByVal strUsuario As String, ByVal strClave As String, ByVal dsFuenteDatos As System.Data.DataSet, ByVal Path As String, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("ImportarDatosTablasDS", New Object() {idDocumento, strNombreDocumento, idCompania, strCompania, strUsuario, strClave, dsFuenteDatos, Path}, Me.ImportarDatosTablasDSOperationCompleted, userState)
        End Sub
