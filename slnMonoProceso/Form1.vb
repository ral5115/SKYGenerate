...
#Region "Detalle"
        If Details.Tables(0).Rows.Count > 0 Then
            For Each item As DataRow In Details.Tables(0).Rows
                ...
                Dim TasaImpDet As XElement = New XElement("TasaImpDet", item.Item("f_TasaImp").ToString)
                ImpuestosDet.Add(TasaImpDet)
                Dim MontoBaseImpDet As XElement = New XElement("MontoBaseImpDet", item.Item("f_MontoBaseImp").ToString)
                ImpuestosDet.Add(MontoBaseImpDet)
                Dim MontoImpDet As XElement = New XElement("MontoImpDet", item.Item("f_MontoImp").ToString)
                ImpuestosDet.Add(MontoImpDet)
